vertex_shader!("src/graphics/renderers/point/indicator/vertex_shader.glsl");
fragment_shader!("src/graphics/renderers/point/indicator/fragment_shader.glsl");
...
impl IndicatorRenderer {
    ...
    pub fn render_ground_indicator(
        ...
        if render_target.bind_subrenderer(PointShadowSubrenderer::Indicator) {
